...
const PROGRAMAS = {
  ...
  'malanje': {
    ...
    roteiro: ['Luanda', 'Ndalatando (KN)', 'City Tour', 'Jardim Botânico / Kilombo', 'Pedras Negras de Pungo a Ndongo', 'Quedas de Kalandula', 'Quedas de Musseleji'],
    itinerario: [
      {
        dia: 'Dia 1',
        titulo: 'Luanda → Pedras Negras',
        texto: 'Recepção e embarque num ponto a definir. Partida rumo a Malanje por Ndalatando com paragem pontual para almoço e visita ao Kilombo/Hortobotânico. Seguir rumo às Pedras Negras de Pungo a Ndongo. Após visita, partida rumo à cidade. Jantar e pernoita.',
        alojamento: 'Hotel em Malanje'
      },
      {
        dia: 'Dia 2',
        titulo: 'Quedas de Kalandula + Musseleji → Regresso',
        texto: 'Após pequeno-almoço, partimos para as Quedas de Kalandula com paragem pela área dos Eucaliptos. Vista superior e inferior das Quedas. Partida para as Quedas de Musseleji onde será feito o almoço à beira do rio. Após o almoço, regresso a Luanda.',
        alojamento: null
      }
    ],
    precos: [
  ...
  'malanje-camping': {
    ...
    roteiro: ['Luanda', 'Dondo (KN)', 'Quedas de Caculo e Cabaça', 'Pedras Negras de Pungo a Ndongo', 'Quedas de Kalandula', 'Quedas de Musseleji'],
    itinerario: [
      {
        dia: 'Dia 1',
        titulo: 'Luanda → Acampamento nas Pedras Negras',
        texto: 'Recepção e embarque. Partida rumo a Malanje pelo Dondo com passagem pelas Quedas de Caculo e Cabaça. Almoço no percurso. Chegada ao nosso acampamento e interação com os locais nas Pedras Negras de Pungo a Ndongo. Jantar e acampamento.',
  ...
  'cabo-ledo': {
    ...
    partida: 'Luanda',
    heroImg: 'imagens/cabo-ledo.webp',
    ...
    roteiro: ['Luanda', 'Miradouro da Lua', 'Gruta das Sereias', 'Praia dos Surfistas (Carpe Diem)'],
    itinerario: [
      {
        dia: '1 Dia',
        titulo: 'Luanda → Cabo Ledo → Regresso 17h30',
        texto: 'Recepção e embarque. Partida nas primeiras horas da manhã rumo a Cabo Ledo com breve paragem no Miradouro da Lua e passagem pela ponte sobre o Rio Kwanza. Exploração da Gruta das Sereias. Momentos tranquilos beira-mar em Carpe Diem. Regresso às 17h30.',
        alojamento: null
      }
    ],
    precos: [
  ...
  'huambo-aguas-frias': {
    ...
    roteiro: ['Luanda', 'Dondo (KN)', 'Waku Kungu', 'Monte Luvili', 'Águas Quentes do Alto Hama', 'Águas Frias', 'City Tour (opcional)'],
    itinerario: [
      {
        dia: 'Dia 1',
        titulo: 'Luanda → Alto Hama',
        texto: 'Recepção e embarque. Partida rumo a Huambo pelo Dondo com paragem na Quibala ou Waku Kungu para almoço. Seguir rumo ao Alto Hama com paragem para conhecer o Monte Luvili e as Águas Quentes. Jantar e pernoita.',
        alojamento: 'Hotel / Bungalow no Alto Hama'
      },
      {
        dia: 'Dia 2',
        titulo: 'Águas Frias — Aventura e Exploração',
        texto: 'Com energias renovadas e após o pequeno-almoço, começamos a nossa experiência de aventura e exploração. Almoço ao som do riacho acompanhado de prato típico local. Jantar e acampamento.',
        alojamento: 'Camping — Águas Frias'
      },
      {
        dia: 'Dia 3',
        titulo: 'City Tour → Regresso a Luanda',
        texto: 'Acordar ao som das águas. Pequeno-almoço antes de nos fazermos à estrada rumo à cidade para um breve City Tour. Regresso a Luanda.',
        alojamento: null
      }
    ],
    precos: [
  ...
  'morro-do-moco': {
    ...
    roteiro: ['Luanda', 'Dondo (KN)', 'Waku Kungu', 'Monte Luvili', 'Águas Quentes do Alto Hama', 'Águas Frias', 'Morro do Moço (2620m)'],
    itinerario: [
      {
        dia: 'Dia 1',
        titulo: 'Luanda → Alto Hama',
      ...
      },
      {
        ...
        texto: 'Com energias renovadas, partimos rumo ao Morro do Moço. Pequeno-almoço pelo caminho. Visita aos dois Sobas Guardiões do Morro. Subida e descida dependem da dinâmica do grupo — a trilha testa os limites, mas não deixe de aproveitar a vista. Jantar e acampamento.',
        alojamento: 'Camping — Morro do Moço'
      },
      {
        dia: 'Dia 3',
        titulo: 'Águas Frias → Regresso a Luanda',
        texto: 'Acordar ao som sinfónico das águas — a recompensa ideal para quem desafiou os seus limites a 2620 metros de altitude. Pequeno-almoço antes de partir rumo a Luanda.',
        alojamento: null
      }
    ],
    precos: [
  ...
  'namibe': {
    ...
    roteiro: ['Transfer Aeroporto / Hotel', 'Camelos (Caraculo)', 'Piscinas Naturais do Piambo', 'Praia do Soba', 'Welwitschia Mirabilis', 'Lagoa do Arco', 'Colinas do Curoca'],
    itinerario: [
      {
        dia: 'Dia 1',
        titulo: 'Chegada ao Namibe — Welwitschia + Colinas do Curoca',
        texto: 'Recepção no Aeroporto Welwitschia Mirabilis. Mochilas nos carros e directo para o hotel. Lanche e visita à Welwitschia, ao Arco e às Colinas do Curoca. Almoço nas gigantes sombras das Colinas enquanto contemplamos o pôr do sol. Hotel e vida noturna de Moçâmedes.',
        alojamento: 'Hotel em Moçâmedes'
      },
      {
        dia: 'Dia 2',
        titulo: 'Piscinas Naturais + Praia do Soba',
        texto: 'Após pequeno-almoço, aventura rumo às Piscinas Naturais do Piambo e Praia do Soba. Almoço na magnífica Praia do Soba.',
        alojamento: 'Hotel em Moçâmedes'
      },
      {
        dia: 'Dia 3',
        titulo: 'Camelos do Caraculo → Aeroporto',
        texto: 'Após pequeno-almoço, mochilas feitas e partida para Caraculo para conhecer e passear com os famosos Camelos do Namibe. Regresso ao Aeroporto Welwitschia Mirabilis.',
        alojamento: null
      }
    ],
    precos: [
      { pax: 'Por Pax', valor: '1.000.000 Kz' },
    ],
    inclui: [
      'Guias + Motoristas + Assistência 24/24h',
  ...
  'namibe-dia': {
    ...
    roteiro: ['Welwitschia Mirabilis', 'Lagoa do Arco', 'Colinas do Curoca', 'City Tour', 'Regresso'],
    itinerario: [
      {
        dia: 'Dia 1',
        titulo: 'Namibe — Tour Panorâmico',
        texto: 'Welwitschia Mirabilis — uma das plantas mais antigas do mundo, com exemplares de mais de 2.000 anos. Lagoa do Arco rodeada por impressionantes formações rochosas. Colinas do Curoca, esculpidas pelo vento e pelo tempo. Breve City Tour por Moçâmedes. Regresso ao ponto de partida.',
        alojamento: null
      }
    ],
    precos: [
      { pax: 'Por Pax', valor: '190.000 Kz' },
    ],
    inclui: [
      'Guias + Motoristas',
      'Transporte 4×4 + Combustível (local)',
  ...
  'tuk-tuk': {
    ...
    roteiro: ['Primeiro de Maio', 'Palácio Presidencial', 'Assembleia Nacional', 'Memorial António A. Neto', 'Fortaleza de São Miguel', 'Rua dos Mercadores', 'Largo Rainha Njinga', 'Baía e Ilha de Luanda', 'Chicala de Luanda'],
    itinerario: [
      {
        dia: 'Tour',
        titulo: 'Luanda Histórica de Tuk Tuk',
        texto: 'Percurso panorâmico pelos principais pontos históricos e culturais de Luanda a bordo de tuk tuk. Uma forma divertida e única de conhecer a cidade.',
        alojamento: null
      }
    ],
    precos: [
      { pax: 'Por Pax', valor: '25.000 Kz' },
    ],
    inclui: [
      'Guias',
      'Transporte (Tuk Tuk)',
    ...
    itinerario: [
      {
        ...
        texto: 'Partida de Luanda nas primeiras horas da manhã. Entrada no parque e safari 4×4 guiado pela reserva. Observação de fauna e flora angolana. Almoço no percurso. Regresso a Luanda ao final do dia.',
        alojamento: null
      }
    ],
    precos: [
      { pax: 'Preço', valor: 'A consultar' },
    ],
    inclui: [
      'Guias + Motoristas + Assistência 24/24h',
...
(function () {
  ...
  if (!prog) {
    document.querySelector('.pkg-hero__title').textContent = 'Programa não encontrado';
    return;
  }
  ...
  if (prog.heroImg) {
    heroSection.style.backgroundImage =
      'linear-gradient(to bottom, rgba(0,0,0,0.25) 0%, rgba(0,0,0,0.72) 100%), url("' + prog.heroImg + '")';
  }
  ...
  if (imgBox && prog.fotoSecundaria) {
    imgBox.innerHTML = '<img src="' + prog.fotoSecundaria + '" alt="' + prog.nome + '" class="pkg-img-box__img">';
  }

  /* 6. Texto de descrição */
  document.querySelector('.pkg-descricao').innerHTML = prog.descricao;

  /* 7. Roteiro (lista de stops) */
  const roteiroEl = document.querySelector('.pkg-roteiro__list');
  roteiroEl.innerHTML = prog.roteiro.map(function(stop) {
    return '<li><i class="fa-solid fa-circle-dot"></i>' + stop + '</li>';
  }).join('');

  /* 8. Sidebar — detalhes */
  document.querySelector('.pkg-detail--dur .pkg-detail__value').textContent   = prog.duracao;
  document.querySelector('.pkg-detail--preco .pkg-detail__value').textContent = prog.preco;
  document.querySelector('.pkg-detail--partida .pkg-detail__value').textContent = prog.partida;

  /* 9. Tabela de preços por pax */
  const precosEl = document.querySelector('.pkg-precos__list');
  precosEl.innerHTML = prog.precos.map(function(p) {
    return '<li><span>' + p.pax + '</span><strong>' + p.valor + '</strong></li>';
  }).join('');

  /* 10. Inclui / Não Inclui */
  document.querySelector('.pkg-inclui__list').innerHTML = prog.inclui.map(function(item) {
    return '<li><i class="fa-solid fa-check"></i>' + item + '</li>';
  }).join('');
  document.querySelector('.pkg-nao-inclui__list').innerHTML = prog.naoInclui.map(function(item) {
  ...
  accordionEl.innerHTML = prog.itinerario.map(function(item, i) {
    const aloj = item.alojamento
      ? '<p class="pkg-accordion__note"><i class="fa-solid fa-moon"></i> Alojamento: ' + item.alojamento + '</p>'
      : '';
    return [
      '<div class="pkg-accordion__item">',
      '  <button class="pkg-accordion__trigger" aria-expanded="' + (i === 0 ? 'true' : 'false') + '">',
  ...
  accordionEl.addEventListener('click', function(e) {
    ...
    /* Fechar todos */
    accordionEl.querySelectorAll('.pkg-accordion__trigger').forEach(function(t) {
  ...
  if (outrosGrid) {
    ...
    outrosGrid.innerHTML = outros.map(function(k) {
      const p = PROGRAMAS[k];
      const iconMap = {
        'malanje': 'fa-water', 'malanje-camping': 'fa-campground',
        'cabo-ledo': 'fa-car-side', 'huambo-aguas-frias': 'fa-droplet',
        'morro-do-moco': 'fa-mountain', 'namibe': 'fa-sun',
        'namibe-dia': 'fa-sun', 'tuk-tuk': 'fa-truck-pickup',
        'quicama': 'fa-paw'
      };
      ...
      return [
        ...
        p.heroImg
          ? '<img src="' + p.heroImg + '" alt="' + p.nome + '" class="package-card__img">'
          : '<div class="package-card__ph"><i class="fa-solid ' + icon + '"></i></div>',
        '  </div>',
        ...
        '        <span class="package-card__meta-value">' + p.preco + '</span>',
        '      </div>',
        '      <div class="package-card__meta-item">',
        '        <span class="package-card__meta-label">Duração</span>',
        '        <span class="package-card__meta-value">' + p.duracao + '</span>',
        '      </div>',
        '    </div>',
        '    <div class="package-card__actions">',
        '      <a href="programa.html?d=' + k + '" class="btn btn--primary btn--sm pkg-btn">Saber Mais</a>',
        '    </div>',
        '  </div>',
        '</article>'
      ].join('\n');
  ...
  if (burgerBtn && navLinksBar) {
    burgerBtn.addEventListener('click', function() {
      ...
      if (sidebar) sidebar.classList.toggle('is-open', open && window.innerWidth <= 640);
      if (sidebarOverlay) sidebarOverlay.classList.toggle('is-open', open && window.innerWidth <= 640);
    });
